...
public class EternalItemTagProvider extends ItemTagsProvider
{
    ...
    protected void addTags(HolderLookup.@NotNull Provider provider)
    {
                ...
                tag(EternalItemsGeneralTags.Items.PLATES)
                        ...
                        .add(EternalGeneralItems.PLATE_CATALYRIUM.get())
                        ...
                        .add(EternalGeneralItems.PLATE_QUANTIQUARITE.get())
                        ...
                        .add(EternalGeneralItems.PLATE_TACHYARITE.get())
                        ...
                        .add(EternalGeneralItems.PLATE_VOIDERITE.get())
                ...
                tag(EternalPlates.Items.CATALYRIUM_PLATE).add(EternalGeneralItems.PLATE_CATALYRIUM.get());
                ...
                tag(EternalPlates.Items.QUANTIQUARITE_PLATE).add(EternalGeneralItems.PLATE_QUANTIQUARITE.get());
                tag(EternalPlates.Items.TACHYARITE_PLATE).add(EternalGeneralItems.PLATE_TACHYARITE.get());
                tag(EternalPlates.Items.VOIDERITE_PLATE).add(EternalGeneralItems.PLATE_VOIDERITE.get());
                ...
                tag(Tags.Items.INGOTS)
                        ...
                        .add(EternalGeneralItems.CATALYRIUM_INGOT.get())
                ...
                tag(EternalIngotTags.Items.CATALYRIUM_INGOT).add(EternalGeneralItems.CATALYRIUM_INGOT.get());
                ...
                tag(EternalOreBlockItemTags.Items.ITEM_PERIDOT_ORE_OW).add(EternalGeneralBlocks.PERIDOT_ORE_BLOCK.asItem());
                tag(EternalOreBlockItemTags.Items.ITEM_PERIDOT_ORE_OW).add(EternalGeneralBlocks.DEEPSLATE_PERIDOT_ORE_BLOCK.asItem());
            ...
            tag(EternalStorageMiscBlockItemTags.Items.NETHER_STAR_BLOCK_ST_ITEM).add(EternalGeneralBlocks.NETHER_STAR_BLOCK.asItem());
                ...
                tag(Tags.Items.NUGGETS)
                        ...
                        .add(EternalGeneralItems.CATALYRIUM_NUGGET.get())
                ...
                tag(EternalNuggetsTags.Items.NUGGET_CATALYRIUM).add(EternalGeneralItems.CATALYRIUM_NUGGET.get());
                ...
                tag(Tags.Items.RODS)
                        ...
                        .add(EternalGeneralItems.ROD_CATALYRIUM.get())
                        ...
                        .add(EternalGeneralItems.ROD_QUANTIQUARITE.get())
                        ...
                        .add(EternalGeneralItems.ROD_TACHYARITE.get())
                        ...
                        .add(EternalGeneralItems.ROD_VOIDERITE.get())
                ...
                tag(EternalMetalRodsTags.Items.ROD_CATALYRIUM).add(EternalGeneralItems.ROD_CATALYRIUM.get());
                ...
                tag(EternalGemRodsTags.Items.ROD_QUANTIQUARITE).add(EternalGeneralItems.ROD_QUANTIQUARITE.get());
                tag(EternalGemRodsTags.Items.ROD_TACHYARITE).add(EternalGeneralItems.ROD_TACHYARITE.get());
                tag(EternalGemRodsTags.Items.ROD_VOIDERITE).add(EternalGeneralItems.ROD_VOIDERITE.get());
                ...
                tag(EternalItemsGeneralTags.Items.GEARS)
                        ...
                        .add(EternalGeneralItems.GEAR_CATALYRIUM.get())
                        ...
                        .add(EternalGeneralItems.GEAR_QUANTIQUARITE.get())
                        .add(EternalGeneralItems.GEAR_STEEL.get())
                        .add(EternalGeneralItems.GEAR_TACHYARITE.get())
                        .add(EternalGeneralItems.GEAR_TIN.get())
                        .add(EternalGeneralItems.GEAR_VOIDERITE.get());
                ...
                tag(EternalMetalGearTags.Items.GEAR_CATALYRIUM).add(EternalGeneralItems.GEAR_CATALYRIUM.get());
                ...
                tag(EternalGemGearTags.Items.GEAR_TACHYARITE).add(EternalGeneralItems.GEAR_TACHYARITE.get());
                tag(EternalGemGearTags.Items.GEAR_QUANTIQUARITE).add(EternalGeneralItems.GEAR_QUANTIQUARITE.get());
                tag(EternalGemGearTags.Items.GEAR_VOIDERITE).add(EternalGeneralItems.GEAR_VOIDERITE.get());
                ...
                tag(Tags.Items.DUSTS)
                        ...
                        .add(EternalGeneralItems.CATALYRIUM_DUST.get())
                        ...
                        .add(EternalGeneralItems.QUANTIQUARITE_DUST.get())
                        ...
                        .add(EternalGeneralItems.TACHYARITE_DUST.get())
                        ...
                        .add(EternalGeneralItems.VOIDERITE_DUST.get())
                ...
                tag(EternalMetalDustsTags.Items.DUST_CATALYRIUM).add(EternalGeneralItems.CATALYRIUM_DUST.get());
                ...
                tag(EternalGemDustsTags.Items.DUST_QUANTIQUARITE).add(EternalGeneralItems.QUANTIQUARITE_DUST.get());
                tag(EternalGemDustsTags.Items.DUST_TACHYARITE).add(EternalGeneralItems.TACHYARITE_DUST.get());
                tag(EternalGemDustsTags.Items.DUST_VOIDERITE).add(EternalGeneralItems.VOIDERITE_DUST.get());
                ...
                tag(Tags.Items.GEMS)
                        ...
                        .add(EternalGeneralItems.GEM_QUANTIQUARITE.get())
                        .add(EternalGeneralItems.GEM_RUBY.get())
                        .add(EternalGeneralItems.GEM_SAPPHIRE.get())
                        .add(EternalGeneralItems.GEM_TACHYARITE.get())
                        .add(EternalGeneralItems.GEM_VOIDERITE.get());
                ...
                tag(EternalGemTags.Items.GEM_QUANTIQUARITE).add(EternalGeneralItems.GEM_QUANTIQUARITE.get());
                tag(EternalGemTags.Items.GEM_TACHYARITE).add(EternalGeneralItems.GEM_TACHYARITE.get());
                tag(EternalGemTags.Items.GEM_VOIDERITE).add(EternalGeneralItems.GEM_VOIDERITE.get());
                ...
                tag(Tags.Items.RAW_MATERIALS)
                        ...
                        .add(EternalGeneralItems.RAW_CATALYRIUM.get())
                ...
                tag(EternalRawMaterialTags.RAW_CATALYRIUM).add(EternalGeneralItems.RAW_CATALYRIUM.get());
