...
public class EternalItemModelProvider extends ItemModelProvider
{
    ...
    protected void registerModels()
    {
        ...
        basicItem(EternalGeneralItems.TACHYARITE_DUST.get());
        basicItem(EternalGeneralItems.QUANTIQUARITE_DUST.get());
        basicItem(EternalGeneralItems.VOIDERITE_DUST.get());
        ...
        basicItem(EternalGeneralItems.ROD_TACHYARITE.get());
        basicItem(EternalGeneralItems.ROD_QUANTIQUARITE.get());
        basicItem(EternalGeneralItems.ROD_VOIDERITE.get());
        ...
        basicItem(EternalGeneralItems.PLATE_QUANTIQUARITE.get());
        basicItem(EternalGeneralItems.PLATE_TACHYARITE.get());
        basicItem(EternalGeneralItems.PLATE_VOIDERITE.get());
        ...
        basicItem(EternalGeneralItems.GEAR_VOIDERITE.get());
        basicItem(EternalGeneralItems.GEAR_QUANTIQUARITE.get());
        basicItem(EternalGeneralItems.GEAR_TACHYARITE.get());
