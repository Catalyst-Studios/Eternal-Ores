...
public class CompressedRecipesEntries extends RecipeProvider
{
    public CompressedRecipesEntries(PackOutput output, CompletableFuture<HolderLookup.Provider> registries)
    {
