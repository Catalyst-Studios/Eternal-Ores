...
public class EOItems
{
    ...
    private static DeferredItem<Item> registerFinder(String name, int durability)
    {
    ...
    public static final DeferredItem<Item> ARDITE_INGOT = registerIngotItem("ardite_ingot");
    ...
    public static final DeferredItem<Item> ARDITE_NUGGET = registerNuggetItem("ardite_nugget");
    ...
    public static final DeferredItem<Item> ROD_ARDITE = registerRodItem("rod_ardite");
    ...
    public static final DeferredItem<Item> PLATE_ARDITE = registerPlateItem("plate_ardite");
    ...
    public static final DeferredItem<Item> GEAR_VOIDERITE = registerGearItem("gear_voiderite");
    ...
    public static final DeferredItem<Item> RAW_ARDITE = registerRawItem("raw_ardite");
    ...
    public static final DeferredItem<Item> ARDITE_DUST = registerDustItem("ardite_dust");
