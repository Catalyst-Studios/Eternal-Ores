...
import static net.radzratz.eternalores.worldgen.placed_features.EOPlacedFeatures.registerKey;

public class EOPlacedKeys
{
    //Aluminum
    ...
    //Ardite
    public static final ResourceKey<PlacedFeature> ARDITE_ORE_PLACED_KEY = registerKey("ardite_ore_placed");
    //Cinnabar
