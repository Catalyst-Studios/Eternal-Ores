...
public class EOBlocks
{
    ...
    public static final DeferredBlock<Block> RAW_ARDITE_BLOCK = registerRawOreBlock("raw_ardite_block", 3f, SoundType.STONE);
    ...
    public static final DeferredBlock<Block> ARDITE_BLOCK = registerMetalBlock("ardite_block", 5f, SoundType.NETHERITE_BLOCK);
