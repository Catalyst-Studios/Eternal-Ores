...
public class EOMekFluids
{
    ...
    public static final SlurryRegistryObject<Chemical, Chemical> ARDITE_SLURRY =
            registerSlurry("ardite", 0xFFd66113, "c:ores/ardite");
    ...
    public static SlurryRegistryObject<Chemical, Chemical> registerSlurry(String name, int tint, String oreTagPath)
    {
