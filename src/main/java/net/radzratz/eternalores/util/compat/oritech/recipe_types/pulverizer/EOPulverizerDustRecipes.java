...
public class EOPulverizerDustRecipes
{
    public static void generateOritechPulverizerRecipe(RecipeOutput output, String materialName,
                                                       TagKey<Item> inputTag, Item outputItem,
                                                       IPulverizerConversion recipeType)
    {
        Ingredient inputIngredient = Ingredient.of(inputTag);
        generateMaterialToDustInternal(output, materialName, inputIngredient, outputItem, recipeType);
    }

    private static void generateMaterialToDustInternal(RecipeOutput output, String materialName,
