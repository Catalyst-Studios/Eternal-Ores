...
public class EternalOresMekanismCompatItems
{
    ...
    public static final DeferredItem<Item> TIN_DIRTY_DUST = registerDirtyDust("dirty_tin_dust");
    ...
    public static final DeferredItem<Item> TIN_CLUMP = registerClumps("clump_tin");
    ...
    public static final DeferredItem<Item> TIN_SHARD = registerShards("shard_tin");
    ...
    public static final DeferredItem<Item> TIN_CRYSTAL = registerCrystals("crystal_tin");
