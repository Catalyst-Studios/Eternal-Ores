...
{
    public EOMekRecipeProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> registries)
    {
    ...
    protected void buildRecipes(@NotNull RecipeOutput output)
    {
        ...
        {
            EOMekRecipeGenerators.generateMekanismProcessingWithoutChemicalRecipe(
        ...
        {
            EOMekRecipeGenerators.generateMekanismProcessingWithChemicalRecipe(
        ...
        {
            EOMekRecipeGenerators.generateMekanismProcessingWithChemicalAndFluidRecipe(
        ...
        {
            EOMekRecipeGenerators.generateMekanismDissolutionRecipe(
        ...
        {
            EOMekRecipeGenerators.generateMekanismCrystallizingRecipe(
